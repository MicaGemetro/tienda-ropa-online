...
document.addEventListener('DOMContentLoaded', () => { 
    // Comentarios fijos iniciales const 
    comentariosFijos = [ 
    ...
    // Cargar comentarios nuevos desde almacenamiento local 
    const comentariosNuevos = JSON.parse(localStorage.getItem('comentarios')) || []; 

    function renderizarComentarios() { 
        const testimoniosLista = document.getElementById("testimonios-lista"); 
        testimoniosLista.innerHTML = ""; // Limpiar los comentarios previos 
        ...
        comentariosFijos.forEach((comentario, index) => { 
            ...
            `; 
            testimoniosLista.appendChild(comentarioElemento); 
        }); 
        ...
        // Renderizar los comentarios cuando se carga la página de testimonios 
        renderizarComentarios(); 

        // Escuchar cambios en el almacenamiento local y volver a renderizar comentarios 
